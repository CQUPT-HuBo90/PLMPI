...
##########################################################################
image_root = '/home/user/chentaiyang/SSLSOD-main/RGBD_SOD_Datasets/Training_dataset/NJUD_NLPR_DUTLFV2_pretext_task/RGB/'
depth_root = '/home/user/chentaiyang/SSLSOD-main/RGBD_SOD_Datasets/Training_dataset/NJUD_NLPR_DUTLFV2_pretext_task/depth/'
gt_root = '/home/user/chentaiyang/SSLSOD-main/RGBD_SOD_Datasets/Training_dataset/NJUD_NLPR_DUTLFV2_pretext_task/depth_contour/'
...
def train(net, optimizer):
    ...
    while True:
        ...
        for i, data in enumerate(train_loader):
            ...
            b, c, h, w = labels.size()
            optimizer.zero_grad()
            target_1 = F.interpolate(labels, size=h // 2, mode='nearest')
            target_2 = F.interpolate(labels, size=h // 4, mode='nearest')
            target_3 = F.interpolate(labels, size=h // 8, mode='nearest')
            target_4 = F.interpolate(labels, size=h // 16, mode='nearest')

            images_raw_1 = F.interpolate(images_raw, size=h // 2, mode='nearest')
            images_raw_2 = F.interpolate(images_raw, size=h // 4, mode='nearest')
            images_raw_3 = F.interpolate(images_raw, size=h // 8, mode='nearest')
            images_raw_4 = F.interpolate(images_raw, size=h // 16, mode='nearest')

            depths_1 = F.interpolate(depths, size=h // 2, mode='nearest')
            depths_2 = F.interpolate(depths, size=h // 4, mode='nearest')
            depths_3 = F.interpolate(depths, size=h // 8, mode='nearest')
            depths_4 = F.interpolate(depths, size=h // 16, mode='nearest')
