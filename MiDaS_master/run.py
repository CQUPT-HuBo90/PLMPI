    ...
    if input_path is not None:
        ...
        for index, image_name in enumerate(image_names):
            ...
            if output_path is not None:
                ...
                # 生成输出文件名，不添加模型类型后缀
                filename = os.path.join(output_path, base_name)
        ...
        with torch.no_grad():
            ...
            while True:
                ...
                if frame is not None:
                    ...
                    if output_path is not None:
                        # 摄像头捕获的帧使用"frame_索引"作为文件名
                        filename = os.path.join(output_path, f'frame_{frame_index}')
                        cv2.imwrite(filename + ".png", content)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input_path',
                        default='/home/user/chentaiyang/MiDaS-master/dst_imgs_all',
